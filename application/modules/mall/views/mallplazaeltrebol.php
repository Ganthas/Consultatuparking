...
<body id="page-top" class="index" style='background-color:#c4cad0'>
		<script type='text/javascript'>mall_trebol()</script>
    <!-- Navigation -->
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                <a class="navbar-brand page-scroll" href="<?php echo base_url(); ?>">
									<img src='<?php echo base_url('img/parking.svg') ?>' width='30px' style='margin-top: 25px;'  class='img-icon'>
								</a>
            </div>
    ...
    <header style='background-color:#c4cad0'>
        <div class="container">
            <div class="intro-text">
							<smal class='place-in'>Estás en Mall Plaza el trebol.</smal>
                <div class="row">
                ...
                <div class="col-lg-12 form-group" style='text-align:center;margin:0 auto;'>
                    <input type="number" class="form-control" min="0" max="24" placeholder="Hora" id="hora" onkeyup='Calcular()' min='1' max="24">
										<input type="number" class="form-control" max="59" placeholder="Minuto" id="minu" onkeyup='Calcular()' min='0' max="59">
